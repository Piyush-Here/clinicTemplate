...
function Contact() {
  ...
  <div className={styles.contactInner}>
    <div>
      ...
      <div className={styles.contactDetail}><div className={styles.contactIcon}>📍</div>123 Health Avenue, Bhubaneswar, Odisha 751001</div>
      <div className={styles.contactDetail}><div className={styles.contactIcon}>📞</div>+91 98765 43210</div>
      <div className={styles.contactDetail}><div className={styles.contactIcon}>📧</div>info@medicare-clinic.com</div>
      <div className={styles.contactDetail}><div className={styles.contactIcon}>🕘</div>Mon–Sat: 9:00 AM – 7:00 PM</div>
    </div>
